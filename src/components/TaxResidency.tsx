      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Establish your legal tax residency in one of the world's most tax-efficient jurisdictions
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gradient-to-br from-slate-50 to-blue-50 p-8 rounded-2xl border border-slate-200 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Create Your Own Company</h3>
            <p className="text-slate-600 mb-6">Full control and ownership of your Dubai-based entity</p>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-700">Complete corporate structure</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-700">Fiscal residency certificate</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-2xl border border-amber-200 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Join Existing Company</h3>
            <p className="text-slate-600 mb-6">Cost-effective solution as an employee</p>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-700">Lower administrative burden</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                <span className="text-slate-700">Fiscal residency certificate</span>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-slate-300">No income, dividend, or wealth tax</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-amber-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-semibold text-lg">Minimal Stay Requirements</div>
                    <div className="text-slate-300">6-8 days first year, 1-2 days following years</div>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-amber-400 flex-shrink-0 mt-0.5" />
                  <div>
                    <div className="font-semibold text-lg">100% Legal & Compliant</div>
                    <div className="text-slate-300">Globally transferable and fully transparent</div>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
              <div className="text-center mb-6">
                <div className="text-5xl font-bold text-amber-400 mb-2">≈€6,000</div>
